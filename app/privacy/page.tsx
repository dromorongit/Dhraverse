      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-gray-600 mb-4 space-y-2">
            ...
            <li>Account credentials (password - stored securely encrypted)</li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-gray-600 mb-4 space-y-2">
            <li><strong>Vendors:</strong> Necessary order and shipping information to fulfill your orders</li>
            <li><strong>Payment Processors:</strong> Paystack handles payment processing securely</li>
            <li><strong>Service Providers:</strong> IT, analytics, and email delivery services</li>
